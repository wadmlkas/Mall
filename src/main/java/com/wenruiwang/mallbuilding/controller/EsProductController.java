...
public class EsProductController {
    ...
    @ApiOperation(value = "import all product in database into ES")
    ...
    @ApiOperation(value = "delete product according to id")
    ...
    @ApiOperation(value = "delete batch product according to ids")
