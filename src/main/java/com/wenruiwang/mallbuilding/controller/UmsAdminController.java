...
import com.wenruiwang.mallbuilding.dto.UmsAdminLoginParam;
...
public class UmsAdminController {
    ...
    public CommonResult login(@RequestBody UmsAdminLoginParam umsAdminLoginParam, BindingResult result) {
        ...
        if (token == null) {
            return CommonResult.validateFailed("username or password error");
        }
    ...
    @ApiOperation("get users' all permission")
